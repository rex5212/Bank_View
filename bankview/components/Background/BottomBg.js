...
const BottomBg = () => {
    return (
        <svg width="588" height="366" viewBox="0 0 588 366" fill="none" xmlns="http://www.w3.org/2000/svg" className='position-fixed bottom-0 end-0'>
            ...
            <path d="M0.146973 366.178L588.78 0.206045L588.78 136.045L218.631 366.178L0.146973 366.178Z" fill="#000AFF" />
        </svg>
    )
}
